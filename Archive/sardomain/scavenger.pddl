...
:parameters (?room - roomOne) 
:precondition (and (has_password) (has_accessKey) (at ?room)
	    )
...
:parameters (?room - roomTwo) 
:precondition (and (no_fire) (has_ladder) (has_hammer) (at ?room)
	    )
...
:parameters (?room - roomTwo) 
:precondition (and (no_fire) (door_unjammed) (at ?room)
	    )
:effect (and (hallway_open)
		)
)
...
:parameters (?room - roomThree) 
:precondition (and (has_electricity) (activate_elecDoor) (at ?room)
	    )
